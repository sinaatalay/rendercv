...
\begin{document}
    ...
    \section{Experience Entries}
        ...
        \resumeSubheading
            {\textbf{Some \textnormal{Company}}}{\textnormal{}}
            {\textit{Software Engineer}}{\textnormal{}}
        ...
        \resumeSubheading
            ...
            {\textit{Software Engineer}}{\textnormal{Sept. 2015 to present}}


        \resumeSubheading
            {\textbf{Some \textnormal{Company}}}{\textit{}}
            {\textit{Software Engineer}}{\textnormal{Jan. 2024}}


        \resumeSubheading
            {\textbf{Some \textnormal{Company}}}{\textit{}}
            {\textit{Software Engineer}}{\textnormal{Sept. 2021}}
    ...
    \section{Education Entries}
        ...
        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textnormal{}}
            {\textit{Mechanical Engineering}}{\textnormal{}}


        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textnormal{}}
            {\textit{BS in Mechanical Engineering}}{\textnormal{}}
        ...
        \resumeSubheading
            ...
            {\textit{Mechanical Engineering}}{\textnormal{Sept. 2015 to present}}


        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textit{}}
            {\textit{Mechanical Engineering}}{\textnormal{Jan. 2024}}


        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textit{}}
            {\textit{Mechanical Engineering}}{\textnormal{Sept. 2021}}
        ...
        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textit{}}
            {\textit{BS in Mechanical Engineering}}{\textnormal{Sept. 2015 to present}}


        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textit{}}
            {\textit{BS in Mechanical Engineering}}{\textnormal{Jan. 2024}}


        \resumeSubheading
            {\textbf{Boğaziçi University}}{\textit{}}
            {\textit{BS in Mechanical Engineering}}{\textnormal{Sept. 2021}}
